...
contract DEX10000 is ERC20{

    IERC20 public token0;
    IERC20 public token1;
    uint256 public conversionRate = 10000 * (10**4) ;
    ...
    */
    ...
    constructor(address _token0, address _token1) ERC20("DEX10000", "DEX10000") {
    ...
    function trade(address tokenFrom, uint256 fromAmount) public {
        if(tokenFrom == address(token0)){
            ...
            if(token1Balances[address(this)] < amountToken1) revert("not enough token1");
            ...
            if(token0Balances[address(this)] < amountToken0) revert("not enough token0");
